...
// func LoadFromFile(configFilePath string, systemDir string) (*config.HyperdriveEthereumConfig, error) {
...
// 	cfg := config.NewHyperdriveEthereumConfig(filepath.Dir(configFilePath), systemDir)
