...
import (
	...
	hetesting "github.com/nodeset-org/hyperdrive-ethereum/testing"
...
var (
	testMgr *hetesting.HyperdriveEthereumTestManager = nil
	logger  *slog.Logger                             = nil
	// nsEmail      string                                   = "test@nodeset.io"
	initSnapshot string

	// SW nodes
	// mainNode        *hetesting.StakeWiseNode
...
func TestMain(m *testing.M) {
	...
	var err error
	testMgr, err = hetesting.NewHyperdriveEthereumTestManager()
	if err != nil {
...
// func registerWithNodeset(node *hetesting.StakeWiseNode, address common.Address) error {
